...
function formatDuration(seconds){
    ...
    let yearsStr = `${years} year${years>1?'s':''}`;
    let daysStr = `${days} day${days>1?'s':''}`;
    let hoursStr = `${hours} hour${hours>1?'s':''}`;
    let minutesStr = `${minutes} minute${minutes>1?'s':''}`;
    let secondsStr = `${secs} second${secs>1?'s':''}`;
    
    if(years>0){
      sentenceArray.push(yearsStr);
    }
    if(days>0){
      sentenceArray.push(daysStr);
    }
    if(hours>0){
      sentenceArray.push(hoursStr);
    }
    if(minutes>0){
      sentenceArray.push(minutesStr);
    }
    if(secs>0){
      sentenceArray.push(secondsStr);
    }
